...
import br.com.adriano.forum.controller.dto.DetalhesDoTopicoDto;
import br.com.adriano.forum.controller.dto.TopicoDto;
import br.com.adriano.forum.controller.form.AtualizacaoTopicoForm;
import br.com.adriano.forum.controller.form.TopicoForm;
...
public class TopicosController {
	...
	public Page<TopicoDto> lista(@RequestParam(required=false) String nomeCurso,
			...
			Direction.DESC,page=0,size=10) Pageable paginacao){
//		Pageable paginacao = PageRequest.of(pagina, qtde,
//				Direction.ASC,ordenacao);
		if(nomeCurso==null) {
			Page<Topico> topicos = topicoRepository.findAll(paginacao);
			return TopicoDto.converter(topicos);
		} else {
			Page<Topico> topicos = topicoRepository.findByCurso_Nome(nomeCurso,
					paginacao);
			return TopicoDto.converter(topicos);
		}			
	}
